...
with open("../database/IVE_courses_ENG.json", "w", encoding="utf-8") as f:
    json.dump(jsonCompatibleData, f, ensure_ascii=False, indent=2)

with open("../database/IVE_courses_CHI.json", "w", encoding="utf-8") as f:
    json.dump(jsonCompatibleData2, f, ensure_ascii=False, indent=2)

with open("../database/IVE_introduce.json", "w", encoding="utf-8") as f:
    json.dump(ive_info, f, ensure_ascii=False, indent=2)

with open("../database/HKIIT_introduce.json", "w", encoding="utf-8") as f:
